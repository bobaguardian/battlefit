...
from .api.muscle_routes import muscle_routes
...
app.register_blueprint(muscle_routes, url_prefix='/api/muscles')
...
app.register_blueprint(battle_routes, url_prefix="/api/battles")
